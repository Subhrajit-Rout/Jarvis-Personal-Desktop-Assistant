...
try:
    from Backend.Brain import JARVISAssistant
...
if __name__ == '__main__':
    ...
    try:
        eel.start('index.html', size=(990, 540), block=True, host='localhost', port=8000, mode="C:\Program Files\Google\Chrome\Application\chrome.exe")
